...
<section class="home">
	...
	<?php 
 				...
 				<?php 
 					 	if (isset($_POST['acao'])) {
 					 		Cadastro::desvincularMotoboy('',$value['myIDMotoboy']);
 					 		Painel::alert('sucesso','Motoboy '.$value['nome'].' desvinculado com sucesso');
 					 		die();
 					 	}
 		...
 		<div class="container-home w100">
 			<div class="container-single w100">
 				<div class="motoboy">
 					 ...
 					 <div class="clear"></div>
 					 <form method="post" class="excluir-motoboy">
 					 	<input type="submit" name="acao" value="Desvincular">
 					 </form>
